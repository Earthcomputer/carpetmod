 ...
 * @see HashCommon
 */
public class NewLong2ObjectOpenHashMap<V> extends AbstractLong2ObjectMap<V> implements java.io.Serializable, Cloneable, Hash {
    ...
    public NewLong2ObjectOpenHashMap(final int expected, final float f) {
     ...
     */
    public NewLong2ObjectOpenHashMap(final int expected) {
     ...
     */
    public NewLong2ObjectOpenHashMap() {
     ...
     *            the load factor.
     */
    public NewLong2ObjectOpenHashMap(final Map<? extends Long, ? extends V> m, final float f) {
        this(m.size(), f);
        putAll(m);
    }
     ...
     *            a {@link Map} to be copied into the new hash map.
     */
    public NewLong2ObjectOpenHashMap(final Map<? extends Long, ? extends V> m) {
     ...
     *            the load factor.
     */
    public NewLong2ObjectOpenHashMap(final Long2ObjectMap<V> m, final float f) {
        this(m.size(), f);
        putAll(m);
    }
     ...
     *            a type-specific map to be copied into the new hash map.
     */
    public NewLong2ObjectOpenHashMap(final Long2ObjectMap<V> m) {
        this(m, DEFAULT_LOAD_FACTOR);
    }
     ...
     */
    public NewLong2ObjectOpenHashMap(final long[] k, final V[] v, final float f) {
        this(k.length, f);
     ...
     *             if <code>k</code> and <code>v</code> have different lengths.
     */
    public NewLong2ObjectOpenHashMap(final long[] k, final V[] v) {
    ...
    private class MapIterator {
         ...
         * key.
         */
        boolean mustReturnNullKey = NewLong2ObjectOpenHashMap.this.containsNullKey;
        /**
        ...
        public int nextEntry() {
            ...
            final long key[] = NewLong2ObjectOpenHashMap.this.key;
            for (;;) {
                if (--pos < 0) {
        ...
        public void remove() {
            ...
            if (last == n) {
                ...
                NewLong2ObjectOpenHashMap.this.remove(wrapped.getLong(-pos - 1));
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements FastEntrySet<V> {
        ...
        public boolean contains(final Object o) {
            ...
            if (((k) == (0))) return NewLong2ObjectOpenHashMap.this.containsNullKey && ((value[n]) == null ? (v) == null : (value[n]).equals(v));
            long curr;
            final long[] key = NewLong2ObjectOpenHashMap.this.key;
            int pos;
            // The starting point.
        ...
        public void clear() {
            NewLong2ObjectOpenHashMap.this.clear();
        }
    }
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public boolean rem(long k) {
            ...
            NewLong2ObjectOpenHashMap.this.remove(k);
            return size != oldSize;
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public NewLong2ObjectOpenHashMap<V> clone() {
        NewLong2ObjectOpenHashMap<V> c;
        try {
            c = (NewLong2ObjectOpenHashMap<V>) super.clone();
